          ...
          child: Column(
            children: [
              ...
              const Align(
                alignment: Alignment.topLeft,
                child: Text(
                  'Follow the steps listed below to properly fill out the required forms for equipment checkout.',
                  style: TextStyle(
                    fontSize: 17.0,
                  ),
                ),
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text(
                      '1) Download and print required form',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 20.0,
                        //fontWeight: FontWeight.bold,
